...
### TMP for the set of all orthologous genes
```{r}
tpm <- dbGetQuery(db,
'SELECT bt2am.bt AS bt, bt2am.am AS am, rbb_amln.ln AS ln, rbb_amlf.lf AS lf, rsem_am.*, rsem_bt.*, rsem_ln.*, rsem_lf.* FROM am2bt
JOIN bt2am
