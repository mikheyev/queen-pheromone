...
#species=ln  #am, bt, ln, lf
#for sbatch: --export=species=am
refdir=./data/raw_reads/trimmed
a=($refdir/$species*_1.fastq.gz) #10 for bt, 6 for am
...
tophat2 -p 12 -G $gff -o ../data/assembly/tophat/$base $ref $f $r
cufflinks  -p 1 -j -g $gff ../data/assembly/tophat/$base/accepted_hits.bam -o ../data/assembly/tophat/$base
